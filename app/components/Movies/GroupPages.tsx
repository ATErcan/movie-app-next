    ...
    <div className="bg-black text-white pt-4 px-4 pb-8 min-h-screen">
      <div className="flex flex-col max-w-7xl mx-auto">
        <div className="flex flex-wrap justify-between items-center px-4 gap-x-4 md:px-6 mb-4">
          <h2 className="my-4 cursor-pointer sm:text-2xl md:text-3xl lg:text-4xl 2xl:text-5xl" onClick={reset}>
            {title} Movies
          </h2>
        ...
        {search && <p className="px-4 mb-2 md:px-6 italic font-light"> {`Search results for "${searchMovie}":`} </p>}
